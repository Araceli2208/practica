...
public class CuentaBancaria {
    ...
    public void depositar(double monto) {
        ...
        historial.add("Depósito de: " + monto + ". Saldo actual: " + saldo + ". Titular: " + titular);
    ...
    public void depositarSeguro(double monto) {
        ...
        if (hash != null) {
            ...
            historial.add("Depósito seguro de: " + monto + ". Hash: " + hash + ". Saldo previo: " + saldoPrevio);
            System.out.println("Depósito seguro exitoso. Hash: " + hash + ". Saldo previo: " + saldoPrevio);
        } else {
    ...
    public static void main(String[] args) {
        ...
        CuentaBancaria cuenta = new CuentaBancaria("Juan Ortiz", 1000);
        ...
        cuenta.retirar(200); // Retiro de 200 unidades de saldo
        cuenta.depositar(100); // Depósito de 100 unidades de saldo
        cuenta.retirar(1500); // Intento de retiro de 1500 unidades (que debería mostrar un mensaje de saldo insuficiente)
